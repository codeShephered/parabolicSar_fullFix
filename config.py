...
INSTRUMENTS = {
    "NIFTY": {
        ...
        "lot_size":        65,
        "strike_interval": 50,
        "expiry_type":     "weekly",   # current Tuesday
        "expiry_weekday":  1,
        #"ce_strike_mode":  "itm",
        #"pe_strike_mode":  "itm",
        "ce_strike_mode":  "otm",
    ...
    "BANKNIFTY": {
        ...
        "lot_size":        30,
        "strike_interval": 100,
        "expiry_type":     "monthly",  # last Tuesday of month
        "expiry_weekday":  1,
        #"ce_strike_mode":  "atm",
        #"pe_strike_mode":  "atm",
        "ce_strike_mode":  "otm",
...
TREND_FILTER_BEARISH_PCT = 1.5 # block bearish if price > 1.5% above SMA20
                                   # wider because price sits above SMA in uptrend
                                   # use 2.0 for BANKNIFTY if needed
