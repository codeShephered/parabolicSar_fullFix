...
Contract selection (constraint 8):
  NIFTY    : current weekly contract (Tuesday expiry).
             If today IS Tuesday (expiry day), use next Tuesday.
             If Tuesday is an NSE holiday, use the preceding Monday.
  BANKNIFTY: monthly contract only (last Tuesday of the month).
